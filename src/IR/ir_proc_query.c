...
void ir_proc_query_init_find_method_regular(
    ...
    ir_proc_query_init_find_func_regular(out_query, compiler, object, name, arg_types, length, TRAIT_NONE, TRAIT_NONE, from_source);
...
void ir_proc_query_init_find_method_conforming(
    ...
    ir_proc_query_init_find_func_conforming(out_query, builder, name, inout_arg_values, inout_arg_types, inout_length, optional_gives, false, from_source);
    out_query->struct_name = struct_name;
}
...
void ir_proc_query_init_find_method_conforming_without_defaults(
    ...
    ir_proc_query_init_find_func_conforming_without_defaults(out_query, builder, name, arg_values, arg_types, length, optional_gives, false, from_source);
    out_query->struct_name = struct_name;
}
