...
if %errorlevel% neq 0 popd & exit /b %errorlevel%
call :compile anonymous_composites
if %errorlevel% neq 0 popd & exit /b %errorlevel%
...
if %errorlevel% neq 0 popd & exit /b %errorlevel%
call :compile fixed_array_var_size_field
if %errorlevel% neq 0 popd & exit /b %errorlevel%
call :compile for
if %errorlevel% neq 0 popd & exit /b %errorlevel%
...
if %errorlevel% neq 0 popd & exit /b %errorlevel%
call :compile permissive_blocks
if %errorlevel% neq 0 popd & exit /b %errorlevel%
...
if %errorlevel% neq 0 popd & exit /b %errorlevel%
call :compile repeat_using
if %errorlevel% neq 0 popd & exit /b %errorlevel%
call :compile return_every_case
if %errorlevel% neq 0 popd & exit /b %errorlevel%
