...
#define EXPR_DELETE         0x0000003B
#define EXPR_BREAK          0x0000003C
#define EXPR_CONTINUE       0x0000003D
#define EXPR_BREAK_TO       0x0000003E
#define EXPR_CONTINUE_TO    0x0000003F
