...
#define TOKEN_BREAK            0x00000042
#define TOKEN_CASE             0x00000043
#define TOKEN_CAST             0x00000044
#define TOKEN_CONTINUE         0x00000045
#define TOKEN_DANGEROUS        0x00000046
#define TOKEN_DEF              0x00000047
#define TOKEN_DEFAULT          0x00000048
#define TOKEN_DEFER            0x00000049
#define TOKEN_DELETE           0x0000004A
#define TOKEN_DYNAMIC          0x0000004B
#define TOKEN_ELSE             0x0000004C
#define TOKEN_ENUM             0x0000004D
#define TOKEN_EXTERNAL         0x0000004E
#define TOKEN_FALSE            0x0000004F
#define TOKEN_FOR              0x00000050
#define TOKEN_FOREIGN          0x00000051
#define TOKEN_FUNC             0x00000052
#define TOKEN_FUNCPTR          0x00000053
#define TOKEN_GLOBAL           0x00000054
#define TOKEN_IF               0x00000055
#define TOKEN_IMPORT           0x00000056
#define TOKEN_IN               0x00000057
#define TOKEN_INOUT            0x00000058
#define TOKEN_LINK             0x00000059
#define TOKEN_NEW              0x0000005A
#define TOKEN_NULL             0x0000005B
#define TOKEN_OR               0x0000005C
#define TOKEN_OUT              0x0000005D
#define TOKEN_PACKED           0x0000005E
#define TOKEN_PRAGMA           0x0000005F
#define TOKEN_PRIVATE          0x00000060
#define TOKEN_PUBLIC           0x00000061
#define TOKEN_RETURN           0x00000062
#define TOKEN_SIZEOF           0x00000063
#define TOKEN_STATIC           0x00000064
#define TOKEN_STDCALL          0x00000065
#define TOKEN_STRUCT           0x00000066
#define TOKEN_SWITCH           0x00000067
#define TOKEN_TRUE             0x00000068
#define TOKEN_UNDEF            0x00000069
#define TOKEN_UNLESS           0x0000006A
#define TOKEN_UNTIL            0x0000006B
#define TOKEN_WHILE            0x0000006C
// 6D..6F
