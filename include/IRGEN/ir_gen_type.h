...
#define CONFORM_MODE_INT_TO_BOOL   TRAIT_7    // Allow conforming from integers to bool
#define CONFORM_MODE_ALL           TRAIT_ALL  // Allow all conformation methods

#define CONFORM_MODE_CALL_ARGUMENTS       CONFORM_MODE_POINTERPTR
#define CONFORM_MODE_CALL_ARGUMENTS_LOOSE CONFORM_MODE_PRIMITIVES | CONFORM_MODE_POINTERPTR
#define CONFORM_MODE_ASSIGNING            CONFORM_MODE_PRIMITIVES | CONFORM_MODE_POINTERPTR | CONFORM_MODE_PTR_TO_BOOL | CONFORM_MODE_INT_TO_BOOL
...
// NOTE: 'allow_indexed' specifies whether the resolved type can contain indexed types
